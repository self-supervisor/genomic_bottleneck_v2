...
save_path = "/network/scratch/a/augustine.mavor-parker/MNIST_results/2024-07-29/"
...
(seed, ratio, model_cf) = para_comb[args.array_id]
...
if __name__ == "__main__":
    ...
    home_path = "/network/scratch/a/augustine.mavor-parker/MNIST_results/2024-08-02"
    ...
    for step_idx in range(number_of_epochs):
        _, _, correct_per_batch_test = trainMNIST(
            model,
            "MLP",
            device,
            train_loader_mnist,
