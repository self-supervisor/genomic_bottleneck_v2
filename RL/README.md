...
Then edit the code in plot.py (which searches for the results with glob) for your path and times of the generated CSVs and then plots the scatter plots (figure 3 in the [manuscript](https://www.biorxiv.org/content/10.1101/2024.08.07.606541v1.abstract)).
